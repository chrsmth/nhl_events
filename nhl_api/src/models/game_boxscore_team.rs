...
pub struct GameBoxscoreTeam {
    ...
    pub team: Option<Box<crate::models::GameBoxscoreTeamTeam>>,
    #[serde(rename = "teamStats", skip_serializing_if = "Option::is_none")]
    pub team_stats: Option<Box<crate::models::GameBoxscoreTeamTeamStats>>,
    #[serde(rename = "players", skip_serializing_if = "Option::is_none")]
    pub players: Option<Box<crate::models::GameBoxscoreTeamPlayers>>,
    ...
    pub on_ice_plus: Option<Vec<crate::models::GameBoxscoreTeamOnIcePlusInner>>,
    ...
    pub coaches: Option<Vec<crate::models::GameBoxscoreTeamCoachesInner>>,
}
