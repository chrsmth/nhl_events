...
pub struct GameLiveData {
    ...
    pub plays: Option<Box<crate::models::GameLiveDataPlays>>,
    ...
    pub boxscore: Option<Box<crate::models::GameBoxscore>>,
    #[serde(rename = "decisions", skip_serializing_if = "Option::is_none")]
    pub decisions: Option<Box<crate::models::GameLiveDataDecisions>>,
}
