...
pub struct TeamNextGameScheduleDatesInner {
    ...
    pub games: Option<Vec<crate::models::TeamNextGameScheduleDatesInnerGamesInner>>,
...
impl TeamNextGameScheduleDatesInner {
    pub fn new() -> TeamNextGameScheduleDatesInner {
