...
pub struct GameEditorial {
    ...
    pub token_data: Option<Box<crate::models::GameEditorialTokenData>>,
    #[serde(rename = "contributor", skip_serializing_if = "Option::is_none")]
    pub contributor: Option<Box<crate::models::GameEditorialContributor>>,
    ...
    pub primary_keyword: Option<Box<crate::models::GameEditorialKeyword>>,
    #[serde(rename = "media", skip_serializing_if = "Option::is_none")]
    pub media: Option<Box<crate::models::GameEditorialMedia>>,
