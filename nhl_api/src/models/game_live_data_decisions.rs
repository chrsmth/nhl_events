...
pub struct GameLiveDataDecisions {
    ...
    pub winner: Option<Box<crate::models::GameDecisionPlayer>>,
    #[serde(rename = "loser", skip_serializing_if = "Option::is_none")]
    pub loser: Option<Box<crate::models::GameDecisionPlayer>>,
    #[serde(rename = "firstStar", skip_serializing_if = "Option::is_none")]
    pub first_star: Option<Box<crate::models::GameDecisionPlayer>>,
    #[serde(rename = "secondStar", skip_serializing_if = "Option::is_none")]
    pub second_star: Option<Box<crate::models::GameDecisionPlayer>>,
    #[serde(rename = "thirdStar", skip_serializing_if = "Option::is_none")]
    pub third_star: Option<Box<crate::models::GameDecisionPlayer>>,
}
