...
pub struct Team {
    ...
    pub venue: Option<Box<crate::models::Venue>>,
    ...
    pub franchise: Option<Box<crate::models::Franchise>>,
    #[serde(rename = "roster", skip_serializing_if = "Option::is_none")]
    pub roster: Option<Box<crate::models::TeamRoster>>,
    #[serde(rename = "nextGameSchedule", skip_serializing_if = "Option::is_none")]
    pub next_game_schedule: Option<Box<crate::models::TeamNextGameSchedule>>,
