...
pub struct PlayerStatsStatsInnerSplitsInner {
    #[serde(rename = "season", skip_serializing_if = "Option::is_none")]
    pub season: Option<String>,
    #[serde(rename = "stat", skip_serializing_if = "Option::is_none")]
    pub stat: Option<Box<crate::models::PlayerStatsStatsInnerSplitsInnerStat>>,
    ...
    pub opponent: Option<Box<crate::models::DraftDraftsInnerRoundsInnerPicksInnerTeam>>,
    #[serde(rename = "opponentDivision", skip_serializing_if = "Option::is_none")]
    pub opponent_division: Option<Box<crate::models::PlayerStatsStatsInnerSplitsInnerOpponentDivision>>,
    #[serde(rename = "opponentConference", skip_serializing_if = "Option::is_none")]
    pub opponent_conference: Option<Box<crate::models::DivisionConference>>,
}

impl PlayerStatsStatsInnerSplitsInner {
    pub fn new() -> PlayerStatsStatsInnerSplitsInner {
