...
pub async fn get_schedule(configuration: &configuration::Configuration, expand: Option<&str>, team_id: Option<&str>, start_date: Option<String>, end_date: Option<String>) -> Result<crate::models::Schedule, Error<GetScheduleError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/schedule", local_var_configuration.base_path);
